            ...
            <ul class="navbar-nav" id="navbar-nav">
                            ...
                            <div class="col-lg-4">
                                <ul class="nav nav-sm flex-column">
                                    ...
                                    <li class="nav-item">
                                     ...
                                     <li class="nav-item">
										<a href="ui-links" class="nav-link"><span><?php echo app('translator')->get('translation.links'); ?></span></a>
                                    </li>
                                    <li class="nav-item">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarIcons">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="icons-remix" class="nav-link"><span><?php echo app('translator')->get('translation.remix'); ?></span><span class="badge badge-pill bg-info">v3.5</span></a>
                            </li>
                            <li class="nav-item">
                                <a href="icons-boxicons" class="nav-link"><span><?php echo app('translator')->get('translation.boxicons'); ?></span><span class="badge badge-pill bg-info">v2.1.4</span></a>
                            </li>
                            <li class="nav-item">
                                <a href="icons-materialdesign" class="nav-link"><span><?php echo app('translator')->get('translation.material-design'); ?></span><span class="badge badge-pill bg-info">v7.2.96</span></a>
                            </li>
                            <li class="nav-item">
                                <a href="icons-lineawesome" class="nav-link"><?php echo app('translator')->get('translation.line-awesome'); ?></a>
                            </li>
                            <li class="nav-item">
                                <a href="icons-feather" class="nav-link"><span><?php echo app('translator')->get('translation.feather'); ?></span><span class="badge badge-pill bg-info">v4.29</span></a>
                            </li>
                            <li class="nav-item">
...
<?php /**PATH /var/www/html/galaxy/resources/views/layouts/sidebar.blade.php ENDPATH**/ ?>