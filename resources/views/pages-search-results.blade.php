                ...
                <div class="card-body p-4">
                    <div class="tab-content text-muted">
                        <div class="tab-pane active" id="all" role="tabpanel">
                                            ...
                                            <div class="col-md-3 col-sm-6">
                                                <div>
                                                    <a href="{{ URL::asset('build/images/small/img-1.jpg') }}" class="image-popup d-block">
                                                        <img src="{{ URL::asset('build/images/small/img-1.jpg') }}" alt="" class="img-fluid d-block rounded" />
                                                    </a>
                                                </div>
                                            </div><!--end col-->
                                            <div class="col-md-3 col-sm-6">
                                                <div>
                                                    <a href="{{ URL::asset('build/images/small/img-3.jpg') }}" class="image-popup d-block">
                                                        <img src="{{ URL::asset('build/images/small/img-3.jpg') }}" alt="" class="img-fluid d-block rounded" />
                                                    </a>
                                                </div>
                                            </div><!--end col-->
                                            <div class="col-md-3 col-sm-6">
                                                <div>
                                                    <a href="{{ URL::asset('build/images/small/img-4.jpg') }}" class="image-popup d-block">
                                                        <img src="{{ URL::asset('build/images/small/img-4.jpg') }}" alt="" class="img-fluid d-block rounded" />
                                                    </a>
                                                </div>
                                            </div><!--end col-->
                                            <div class="col-md-3 col-sm-6">
                                                <div class="search-more-results rounded">
                                                    <a href="javascript:void(0);" onclick="myFunction()" class="d-block">
                                                        <img src="{{ URL::asset('build/images/small/img-5.jpg') }}" alt="" class="img-fluid d-block rounded" />
                            ...
                            <div class="py-3">
                                <h5 class="mb-1"><a href="javascript:void(0);">Skote - Admin & Dashboard Template by OIM</a></h5>
                            ...
                            <div class="py-3">
                                <h5 class="mb-1"><a href="javascript:void(0);">Doson - Angular Admin & Dashboard Template by OIM</a></h5>
                                        ...
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="d-flex align-items-center border border-dashed rounded p-2">
                                                    <div class="flex-shrink-0">
                                                        <img src="{{ URL::asset('build/images/small/img-12.jpg') }}" alt="" width="65" class="rounded" />
                                                    </div>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="d-flex align-items-center border border-dashed rounded p-2">
                                                    <div class="flex-shrink-0">
                                                        <img src="{{ URL::asset('build/images/small/img-11.jpg') }}" alt="" width="65" class="rounded" />
                                                    </div>
                                                    <div class="flex-grow-1 ms-2">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="d-flex align-items-center border border-dashed rounded p-2">
                                                    <div class="flex-shrink-0">
                                                        <img src="{{ URL::asset('build/images/small/img-10.jpg') }}" alt="" width="65" class="rounded" />
                                                    </div>
                                                    <div class="flex-grow-1 ms-2">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="d-flex align-items-center border border-dashed rounded p-2">
                                                    <div class="flex-shrink-0">
                                                        <img src="{{ URL::asset('build/images/small/img-9.jpg') }}" alt="" width="65" class="rounded" />
                                                    </div>
                                                    <div class="flex-grow-1 ms-2">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="d-flex align-items-center border border-dashed rounded p-2">
                                                    <div class="flex-shrink-0">
                                                        <img src="{{ URL::asset('build/images/small/img-8.jpg') }}" alt="" width="65" class="rounded" />
                                                    </div>
                                                    <div class="flex-grow-1 ms-2">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="d-flex align-items-center border border-dashed rounded p-2">
                                                    <div class="flex-shrink-0">
                                                        <img src="{{ URL::asset('build/images/small/img-7.jpg') }}" alt="" width="65" class="rounded" />
                                                    </div>
                                                    <div class="flex-grow-1 ms-2">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="d-flex align-items-center border border-dashed rounded p-2">
                                                    <div class="flex-shrink-0">
                                                        <img src="{{ URL::asset('build/images/small/img-6.jpg') }}" alt="" width="65" class="rounded" />
                                                    </div>
                                                    <div class="flex-grow-1 ms-2">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="d-flex align-items-center border border-dashed rounded p-2">
                                                    <div class="flex-shrink-0">
                                                        <img src="{{ URL::asset('build/images/small/img-5.jpg') }}" alt="" width="65" class="rounded" />
                                                    </div>
                                                    <div class="flex-grow-1 ms-2">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="d-flex align-items-center border border-dashed rounded p-2">
                                                    <div class="flex-shrink-0">
                                                        <img src="{{ URL::asset('build/images/small/img-3.jpg') }}" alt="" width="65" class="rounded" />
                                                    </div>
                                                    <div class="flex-grow-1 ms-2">
                                ...
                                <div class="col-lg-6">
                                    <div class="card border">
                                        <div class="card-body">
                                            <div class="d-sm-flex">
                                                <div class="flex-shrink-0">
                                                    <img src="{{ URL::asset('build/images/small/img-1.jpg') }}" alt="" width="115" class="rounded-1" />
                                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="card border">
                                        <div class="card-body">
                                            <div class="d-sm-flex">
                                                <div class="flex-shrink-0">
                                                    <img src="{{ URL::asset('build/images/small/img-2.jpg') }}" alt="" width="115" class="rounded-1" />
                                                </div>
                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                    <ul class="list-inline mb-2">
                                ...
                                <div class="col-lg-6">
                                    <div class="card border">
                                        <div class="card-body">
                                            <div class="d-sm-flex">
                                                <div class="flex-shrink-0">
                                                    <img src="{{ URL::asset('build/images/small/img-3.jpg') }}" alt="" width="115" class="rounded-1" />
                                                </div>
                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                    <ul class="list-inline mb-2">
                                ...
                                <div class="col-lg-6">
                                    <div class="card border">
                                        <div class="card-body">
                                            <div class="d-sm-flex">
                                                <div class="flex-shrink-0">
                                                    <img src="{{ URL::asset('build/images/small/img-4.jpg') }}" alt="" width="115" class="rounded-1" />
                                                </div>
                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                    <ul class="list-inline mb-2">
                                ...
                                <div class="col-lg-6">
                                    <div class="card border">
                                        <div class="card-body">
                                            <div class="d-sm-flex">
                                                <div class="flex-shrink-0">
                                                    <img src="{{ URL::asset('build/images/small/img-5.jpg') }}" alt="" width="115" class="rounded-1" />
                                                </div>
                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                    <ul class="list-inline mb-2">
                                                        <li class="list-inline-item"><span class="badge bg-success-subtle text-success fs-11">Business</span></li>
                                ...
                                <div class="col-lg-6">
                                    <div class="card border">
                                        <div class="card-body">
                                            <div class="d-sm-flex">
                                                <div class="flex-shrink-0">
                                                    <img src="{{ URL::asset('build/images/small/img-6.jpg') }}" alt="" width="115" class="rounded-1" />
                                                </div>
                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                    <ul class="list-inline mb-2">
                                ...
                                <div class="col-lg-6">
                                    <div class="card border">
                                        <div class="card-body">
                                            <div class="d-sm-flex">
                                                <div class="flex-shrink-0">
                                                    <img src="{{ URL::asset('build/images/small/img-7.jpg') }}" alt="" width="115" class="rounded-1" />
                                                </div>
                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                    <ul class="list-inline mb-2">
                                                        <li class="list-inline-item"><span class="badge bg-danger-subtle text-danger fs-11">Design</span></li>
                                ...
                                <div class="col-lg-6">
                                    <div class="card border">
                                        <div class="card-body">
                                            <div class="d-sm-flex">
                                                <div class="flex-shrink-0">
                                                    <img src="{{ URL::asset('build/images/small/img-8.jpg') }}" alt="" width="115" class="rounded-1" />
                                                </div>
                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                    <ul class="list-inline mb-2">
                                                        <li class="list-inline-item"><span class="badge bg-warning-subtle text-warning fs-11">Development</span></li>
