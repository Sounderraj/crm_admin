            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="live-preview">
                        <div class="row">
                        <form action="{{ route('settings.taxrates.update', $taxrates->id) }}" method="post" class="needs-validation" novalidate>
                            @csrf
                            @method('PUT')
                            @csrf
                                ...
                                <div class="row mb-3">                                    
                                    <div class="col-sm-6 form-group">
                                        ...
                                        <input type="text" name="tax_name" id="tax_name" class="form-control" placeholder="Tax Name" value="{{ $taxrates->tax_name }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">                                    
                                    <div class="col-sm-6 form-group">
                                        ...
                                        <input type="text" name="tax_rate_percentage" id="tax_rate_percentage" class="form-control" placeholder="Tax Rate Percentage" value="{{ $taxrates->tax_rate_percentage }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">                                    
                                    <div class="col-sm-6 form-group">
                                        ...
                                        <select name="tax_type" id="tax_type" class="form-control js-example-basic-single select2-hidden-accessible" required >
                                            ...
                                            @endphp
                                            @foreach($data as $val)
                                                <option value="{{ $val }}" {{ $taxrates->tax_type==$val ? 'selected':'' }}  >{{ $val }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
