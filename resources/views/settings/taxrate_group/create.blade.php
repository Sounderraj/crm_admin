...
@section('content')
    @component('components.breadcrumb')
        @slot('li_1') <a href="{{ route('settings.taxrates_group.index') }}">@lang('translation.tax_rate')</a> @endslot
        ...
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Add Tax Group</h4>
                </div><!-- end card header -->
                <div class="card-body">
                    <div class="live-preview">
                        <div class="row">

                            <form action="{{ route('settings.taxrates_group.store') }}" method="post" class="needs-validation" novalidate>
                            @csrf
                                
                                <div class="row mb-3">                                    
                                    <div class="col-sm-6 form-group">
                                        <label>Group Name</label> <span class="text-danger">*</span>
                                        <input type="text" name="tax_name" id="tax_name" class="form-control" placeholder="Group Name" required>
                                    </div>
                                </div>
