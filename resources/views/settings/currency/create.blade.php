                ...
                <div class="card-body">
                    <div class="live-preview">
                        <div class="row">
                            ...
                            <form action="{{ route('settings.currency.store') }}" method="post" class="needs-validation" novalidate>
                            @csrf
                                <div class="row mb-3">                                    
                                ...
                                <div class="row mb-3">                                    
                                    <div class="col-sm-6 form-group">
                                        <div class="form-check form-switch form-switch-md" dir="ltr">
                                            <input type="checkbox" class="form-check-input" id="customSwitchsizemd" name="is_default">
