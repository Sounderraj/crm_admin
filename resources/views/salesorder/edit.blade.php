                ...
                <div class="card-body border-bottom border-bottom-dashed p-4">
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-6 form-group">
                            ...
                            <input type="text" name="sale_order_id" id="sale_order_id" class="form-control" placeholder="Sale order number" value="{{$saleorder->sale_order_id }}" required readonly>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-sm-6 form-group">
                            <label for="name">Reference</label> 
                            <input type="text" name="reference_num" id="reference_num" class="form-control" placeholder="Reference number" value="{{$saleorder->reference_num }}">
                        </div>
                        <div class="col-sm-6 form-group">
                            <label for="name">Sale Order Date</label> 
                            <input type="date" name="saleorder_date" id="saleorder_date" data-provider="flatpickr" data-date-format="d-m-Y" data-deafult-date="{{ $saleorder->saleorder_date }}" 
