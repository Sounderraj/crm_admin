                            ...
                            @csrf
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="type" id="type_b" value="Goods" {{ $product->type == 'Goods' ? 'checked' : ''}}>
                                            <label class="form-check-label" for="type_b">Goods</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="type" id="type_i" value="Service" {{ $product->type == 'Service' ? 'checked' : ''}}>
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-6 form-group">
                                        ...
                                        <input type="text" name="name" id="name" class="form-control" placeholder="Product Name" required value="{{ $product->name }}">
                                    </div>
                                    <div class="col-sm-6 form-group">
                                        <label>SKU </label>
                                        <input type="text" name="sku_number" id="sku_number" class="form-control" placeholder="SKU" value="{{ $product->sku_number }}">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">                                    
                                    <div class="col-sm-6 form-group">
                                        ...
                                        <input type="text" name="hsn_code" id="hsn_code" class="form-control" placeholder="HSN Code" value="{{ $product->hsn_code }}">
                                    </div>
                                    <div class="col-sm-6 form-group">
                                        <label>SAC Code</label>
                                        <input type="text" name="sac_code" id="sac_code" class="form-control" placeholder="SAC Code" value="{{ $product->sac_code }}">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">                                    
                                    <div class="col-sm-6 form-group">
                                        <label>Unit</label>
                                        <input type="text" name="unit" id="unit" class="form-control" placeholder="Unit" value="{{ $product->unit }}">
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-6 form-group">
                                        ...
                                        <select name="tax_preference" id="tax_preference" class="form-control js-example-basic-single select2-hidden-accessible" required onchange="toggleTaxPrefFields()">
                                            ...
                                            @foreach($tax_prefArr as $val)
                                                <option value="{{ $val }}" {{ $product->tax_preference==$val ? 'selected':'' }} >{{ $val }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="row mb-5 tax_rate_select_div">                                    
                                    <div class="col-sm-6 form-group">
                                        ...
                                        <select name="intra_tax_rate_id" id="intra_tax_rate_id" class="form-control js-example-basic-single select2-hidden-accessible" required>
                                            @php
                                                $sid = $product->intra_tax_rate_id ??  $taxrates_default->intra_tax_rate_id ?? '';
                                            @endphp
                                    ...
                                    <div class="col-sm-6 form-group tax_rate_select_div">
                                        ...
                                        <select name="inter_tax_rate_id" id="inter_tax_rate_id" class="form-control js-example-basic-single select2-hidden-accessible" required>
                                            @php
                                                $sid = $product->inter_tax_rate_id ?? $taxrates_default->inter_tax_rate_id ?? '';
                                            @endphp    
                                            @foreach($taxrates as $val)
                                                <option value="{{ $val->id }}" {{ $sid==$val->id ? 'selected':'' }}>{{ $val->tax_name ." [". $val->tax_rate_percentage ."%]" }}</option>
                                            @endforeach
                                ...
                                <div class="row mb-5">
                                    ...
                                    <div class="col-sm-4 form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="selling_price" id="selling_price" class="form-control" placeholder="Selling Price" aria-label="Selling Price" aria-describedby="basic-addon2" required value="{{ $product->selling_price }}">
                                        </div>
                                    </div>
                                    <div class="col-sm-4 form-group">
                                        <label>Description</label>
                                        <textarea name="s_desc" id="s_desc" class="form-control" rows="2" placeholder="Description">{{ $product->s_desc }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-4 form-group ">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="cost_price" id="cost_price" class="form-control" placeholder="Cost Price" aria-label="Cost Price" aria-describedby="basic-addon1" required value="{{ $product->cost_price }}">
                                        </div>
                                    </div>
                                    <div class="col-sm-4 form-group">
                                        <label>Description</label>
                                        <textarea name="p_desc" id="p_desc" class="form-control" rows="2" placeholder="Description">{{ $product->p_desc }}</textarea>
                                    </div>
                                </div>
                                <div class="row mb-3">                                    
                                    <div class="col-sm-6 form-group">
                                        <div class="form-check form-switch form-switch-md" dir="ltr">
                                            <input type="checkbox" class="form-check-input" id="track_inventry" name="track_inventry" {{ $product->track_inventry ? 'checked':'' }}>
                                ...
                                <div class="row mb-5 inventory_select_div">                                    
                                    <div class="col-sm-6 form-group">
                                        ...
                                        <input type="text" name="stock_in_hand" id="stock_in_hand" class="form-control" placeholder="Stock in hand" value="{{ $product->stock_in_hand }}">
                                    </div>
                                </div>
