...
@section('title') @lang('translation.estimates') @endsection
@section('css')
<!--datatables css-->
                            ...
                            <table id="example" class="table table-bordered dt-responsive nowrap table-striped align-middle mt-3" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @can('estimate-show')
                                                <a class="btn btn-sm btn-info" href="{{ route('estimate.show',$estimate->id) }}">Show</a>
                                            @endcan
                                            @can('estimate-edit')
                                                <a class="btn btn-sm btn-primary" href="{{ route('estimate.edit',$estimate->id) }}">Edit</a>
                                            @endcan
                                            @can('estimate-delete')
                                                {!! Form::open(['method' => 'DELETE', 'route' => ['estimate.destroy', $estimate->id], 'style' => 'display:inline']) !!}
