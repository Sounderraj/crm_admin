...
@section('title') @lang('translation.purchaseorder') @endsection
@section('css')
<!--datatables css-->
...
@section('content')
    @component('components.breadcrumb')
        @slot('li_1') <a href="{{ route('orders.index') }}">@lang('translation.purchaseorder')</a> @endslot
        @slot('title') @lang('translation.purchaseorder') @endslot
    @endcomponent
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Purchase Orders List</h4>
                    <div class="flex-shrink-0">
                        <div class="form-check form-switch form-switch-right form-switch-md">
                            @can('purchaseorder-create')
                                <a href="{{ route('orders.create') }}" >
                                <button type="button" class="btn btn-md btn-primary">
                                    <i class="ri-add-line align-middle me-1"></i>Add Purchase Order
                                </button>
                                </a>
                            @endcan
                        </div>
