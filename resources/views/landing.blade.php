                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-8 col-sm-10">
                            <div class="text-center mt-lg-5 pt-5">
                                <h1 class="display-6 fw-semibold mb-3 lh-base">The better way to manage your website with <span class="text-primary">Velzon </span></h1>
                                ...
                                <div class="d-flex gap-2 justify-content-center mt-4">
                                    ...
                                    <a href="pages-pricing" class="btn btn-soft-primary">View Plans <i class="ri-eye-line align-middle ms-1"></i></a>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-8">
                            <div class="text-center mb-5">
                                ...
                                <div class="hstack gap-2 justify-content-center">
                                    ...
                                    <button type="button" class="btn btn-soft-secondary btn-label rounded-pill"><i class="ri-twitter-line label-icon align-middle rounded-pill fs-16 me-2"></i> Send Us Tweet</button>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card">
                                <div class="card-body text-center p-4">
                                    <div class="avatar-xl mx-auto mb-4 position-relative">
                                        ...
                                        <a href="apps-mailbox" class="btn btn-primary btn-sm position-absolute bottom-0 end-0 rounded-circle avatar-xs">
                        ...
                        <div class="col-lg-4 mt-4">
                            <div>
                                ...
                                <div class="mt-4 fs-14">
                                    ...
                                    <p class="ff-secondary">You can build any type of web application like eCommerce, CRM, CMS, Project management apps, Admin Panels, etc using CRM</p>
                                </div>
                            </div>
                        </div>
