            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="live-preview">
                        <div class="row">
                            <form action="{{ route('vendors.store') }}" method="post" class="needs-validation" novalidate>
                            @csrf
                            <div class="row">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" name="vendor_name" id="vendor_name" class="form-control" placeholder="Vendor display name" required>
                                    </div>
                                </div>
