                    ...
                    <form action="{{ route('customer.update', $user->id) }}" method="post" class="needs-validation" novalidate>
                        ...
                        <div class="row">
                            <div class="row mb-4">
                                ...
                                <div class="col-sm-10">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="customer_type" required id="customer_type_b" value="Business" {{ $user->customer_type == 'Business' ? 'checked' : ''}}>
                                        <label class="form-check-label" for="customer_type_b">Business</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="customer_type" required id="customer_type_i" value="Individual" {{ $user->customer_type == 'Individual' ? 'checked': ''}}>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" name="customer_name" id="customer_name" class="form-control" placeholder="Customer display name" required value="{{ $user->customer_name }}">
                                </div>
                            </div>
