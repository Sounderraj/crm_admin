                  ...
                  <div class="timeline">
                      ...
                      <div class="timeline-item left">
                          ...
                          <div class="content">
                              ...
                              <p class="text-muted">Every team project can have a CRM Use the velzon to share information with your team to understand and contribute to your project.</p>
                              ...
                              <div class="col-12">
                                  <div class="timeline-box">
                                      <div class="timeline-text">
                                          ...
                                          <div class="row border border-dashed rounded gx-2 p-2">
                                              <div class="col-3">
                                                  <a href="javascript:void(0);"><img src="{{ URL::asset('build/images/small/img-7.jpg') }}" alt="" class="img-fluid rounded"></a>
                                              </div><!--end col-->
                                              <div class="col-3">
                                                  <a href="javascript:void(0);"><img src="{{ URL::asset('build/images/small/img-3.jpg') }}" alt="" class="img-fluid rounded"></a>
                                              </div><!--end col-->
                                              <div class="col-3">
                                                  <a href="javascript:void(0);"><img src="{{ URL::asset('build/images/small/img-10.jpg') }}" alt="" class="img-fluid rounded"></a>
                                              </div><!--end col-->
                                              <div class="col-3">
                                                  <a href="javascript:void(0);"><img src="{{ URL::asset('build/images/small/img-9.jpg') }}" alt="" class="img-fluid rounded"></a>
                                              </div><!--end col-->
                                          </div>
                                      </div>
                                  </div>
                      ...
                      <div class="swiper timelineSlider">
                          <div class="swiper-wrapper">
                              <div class="swiper-slide">
                                  <div class="card pt-2 border-0 item-box text-center card-border-effect-none">
